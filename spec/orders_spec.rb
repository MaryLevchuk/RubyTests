...
#require_relative '../lib/pages/orders'
...
describe 'OrdersPage' do
  ...
  # context 'Header' do
  #    it 'is present' do
  #      # expect(on(OrdersPage).header_is_present)
  #    end
  #    context 'contains:' do
  #      context 'Account info' do
  #        it 'Account name similar to chosen in menu same one' do
  #          # expect(on(OrdersPage).account_name_on_header).to include(on(OrdersPage).account_name_in_menu)
  #        end
  #      end
  #
